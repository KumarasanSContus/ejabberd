...
The full API is documented in [API.html](API.html)
...
function or by any other means), it can be decoded using either [decode/1](API.html#decode1)
or [decode/3](API.html#decode3) functions. The result will be an XMPP element. Note
...
[format_error/1](API.html#format_error1) or [io_format_error/1](API.html#io_format_error1)
functions.
...
[encode/1](API.html#encode1) and [encode/2](API.html#encode2) functions can be used for reverse
...
to work with them:
- `id`: [get_id/1](API.html#get_id1) and [set_id/2](API.html#set_id2) can be used
- `type`: [get_type/1](API.html#get_type1) and [set_type/2](API.html#set_type2) can be used
- `lang`: [get_lang/1](API.html#get_lang1) and [set_lang/2](API.html#set_lang2) can be used
- `from` and `to`: [get_from/1](API.html#get_from1), [get_to/1](API.html#get_to1),
  [set_from/2](API.html#set_from2), [set_to/2](API.html#set_to2) and [set_from_to/3](API.html#set_from_to3)
  can be used
- `sub_els`: [get_els/1](API.html#get_els1) and [set_els/2](API.html#set_els2) can be used;
  additional functions to work with subtags directly are:
  [set_subtag/2](API.html#set_subtag2), [get_subtag/2](API.html#get_subtag2),
  [get_subtags/2](API.html#get_subtags2), [try_subtag/2](API.html#try_subtag2),
  [try_subtags/2](API.html#try_subtags2), [remove_subtag/2](API.html#remove_subtag2),
  [has_subtag/2](API.html#has_subtag2), and [append_subtags/2](API.html#append_subtags2).
- `meta`: this field is intended for attaching arbitrary Erlang terms to
  ...
  also using the following functions: [get_meta/1](API.html#get_meta1),
  [get_meta/2](API.html#get_meta2), [get_meta/3](API.html#get_meta3), [set_meta/2](API.html#set_meta2),
  [put_meta/3](API.html#put_meta3), [update_meta/3](API.html#update_meta3) and
  [del_meta/2](API.html#del_meta2)

### Constructing stanza responses

For creating `iq()` replies the following functions exist:
[make_iq_result/1](API.html#make_iq_result1) and [make_iq_result/2](API.html#make_iq_result2).
...
(including `iq()`) [make_error/2](API.html#make_error2) function can be used.
...
[err_bad_request/0](API.html#err_bad_request0) or
[err_internal_server_error/2](API.html#err_internal_server_error2).
To construct `stream_error()` elements the functions with `serr_` prefix
can be used, such as [serr_not_well_formed/0](API.html#serr_not_well_formed0) or
[serr_invalid_from/2](API.html#serr_invalid_from2).
...
to manipulate with `text()` elements: [get_text/1](API.html#get_text1),
[get_text/2](API.html#get_text2), [mk_text/1](API.html#mk_text1) and [mk_text/2](API.html#mk_text2).

## Pretty printer

For pretty printing of XMPP elements (for example, for dumping elements in
the log in a more readable form), [pp/1](API.html#pp1) function can be used.
...
There is also [get_ns/1](API.html#get_ns1) function which can be used
...
Functions for working with JIDs are provided by [jid](API.html#jid) module.
...
To set the callback one can use [set_tr_callback/1](API.html#set_tr_callback1)
