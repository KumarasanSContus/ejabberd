...
-xml(user_fav,
	   ...
	   module = 'user_fav',
           result = {user_fav, '$to_user','$message_id','$chat_type','$status','$result_type','$type','$position','$limit','$row_id','$_els'},
...
-xml(group_chat_query,
	   ...
	   module = 'mix_group_chat',
           result = {group_query,'$status','$type','$msgid','$admin_user','$group_id','$sync_time','$removedtype','$org_name','$ptt_status', '$message_id', '$subscriptions','$participants','$result_type','$_els'},
                     attrs = [#attr{name = <<"status">>,default = <<"">>},
                              #attr{name = <<"type">>,default = <<"">>},
                              #attr{name = <<"admin_user">>,default = <<"">>},
                              #attr{name = <<"group_id">>,default = <<"">>},
                              #attr{name = <<"sync_time">>,default = <<"0">>},
                              #attr{name = <<"removedtype">>,default = <<"0">>},
                              #attr{name = <<"org_name">>,default = <<"">>},
...
-xml(group_chat_participant,
             ...
             xmlns = <<"jabber:iq:mixgroupchat">>,
  	   module = 'mix_group_chat',
             result = {group_participant, '$result_type'},
             cdata = #cdata{default = <<"">>, label = '$result_type'}}).
...
-xml(broadcast_tag,
           ...
           xmlns = <<"jabber:iq:mod_broadcast">>,
	   module = 'broadcast',
           result = {broadcast, '$name', '$users','$status','$content','$notification','$detail','$type','$title','$bname','$team_id','$organization_type','$offline_enable','$message_id','$message_type','$participants','$broadcastname','$broadcastid'},
           attrs = [#attr{name = <<"name">>, default = <<"">>},
            #attr{name = <<"content">>, default = <<"">>},
            #attr{name = <<"notification">>,default = <<"">>},
          #attr{name = <<"detail">>,default = <<"">>},
          #attr{name = <<"type">>,default = <<"">>},
          #attr{name = <<"title">>,default = <<"">>},
          #attr{name = <<"bname">>,default = <<"">>},
          #attr{name = <<"team_id">>, default = <<"">>},
          #attr{name = <<"organization_type">>, default = <<"">>},
          #attr{name = <<"offline_enable">>,default = <<"">>},
          #attr{name = <<"message_id">>,default = <<"">>},
...
-xml(media_call_activities,
	   ...
	   module = 'media_call_activities',
           ...
           '$call_from','$call_time','$call_type','$end_time' ,'$room_id','$group_id','$call_link','$result_type'
           ,'$_els'},
                     attrs = [#attr{name = <<"type">>,default = <<"">>},
...
-xml(user_activities,
	   ...
	   module = 'user_activities',
           result = {user_activities, '$remove_user', '$type', '$license_data', '$result_type','$status','$password',
           '$socket_id','$message','$message_from','$message_type','$message_to','$to_user','$mode','$message_id','$message_ids','$chat_type','$reply_id','$delete_type','$favourite','$_els','$position','$limit','$row_id',
           '$sync_time','$call_status','$call_type','$caller_device','$call_id','$call_attend_status','$mute_status','$archive_status','$group_id','$archive'},
...
-xml(mediacall,
           ...
           xmlns = <<"urn:xmpp:call">>,
	   module = 'call',
           result = {mediacall, '$call_mode', '$call_time','$call_status','$call_from','$call_type', '$room_id','$group_id','$call_link'},
...
-xml(chatcontent,
	   ...
	   module = 'chatcontent',
           result = {chatcontent, '$block_user', '$broadcast_id','$broadcast_msgid',
           '$notification','$organization_type','$offline_enable','$is_broadcast','$detail','$type','$title','$bname','$message_type'},
           attrs = [#attr{name = <<"block_user">>,default = <<"0">>},
                    ...
                    #attr{name = <<"organization_type">>,default = <<"">>},
                    #attr{name = <<"offline_enable">>,default = <<"">>},
                    #attr{name = <<"is_broadcast">>, default = <<"">>},
                    #attr{name = <<"detail">>,default = <<"">>},
                    #attr{name = <<"type">>,default = <<"">>},
                    #attr{name = <<"title">>,default = <<"">>},
                    #attr{name = <<"bname">>,default = <<"">>},
...
-xml(recall,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'recall',
           result = {recall, '$id', '$time','$chat_type','$prev_message_id', '$group_id'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
                    #attr{name = <<"chat_type">>,default = <<"">>},
                     #attr{name = <<"prev_message_id">>,default = <<"">>},
                    #attr{name = <<"group_id">>,default = <<"">>},
                    #attr{name = <<"time">>,default = <<"">>}]}).
...
-xml(roster_vcard,
            ...
            xmlns = <<"jabber:iq:roster">>,
      module = 'rfc6121',
            result = {roster_vcard, '$roster_vcard','$roster_nickname','$roster_status','$roster_mobilenumber','$roster_coverimg','$roster_designation','$roster_name','$roster_image','$roster_email'},
...
-xml(vcard_lastName,
           ...
           xmlns = <<"vcard-temp">>,
	   module = 'xep0054',
          result = {vcard_lastName, '$vcard_lastName'},
              cdata = #cdata{default = <<"">>, label = '$vcard_lastName'}}).

-xml(vcard_userType,
     #elem{name = <<"userType">>,
           xmlns = <<"vcard-temp">>,
	   module = 'xep0054',
          result = {vcard_userType, '$vcard_userType'},
              cdata = #cdata{default = <<"">>, label = '$vcard_userType'}}).

-xml(vcard_firstName,
     #elem{name = <<"firstName">>,
           xmlns = <<"vcard-temp">>,
	   module = 'xep0054',
          result = {vcard_firstName, '$vcard_firstName'},
              cdata = #cdata{default = <<"">>, label = '$vcard_firstName'}}).
...
-xml(roster_item,
	   ...
	   module = rfc6121,
           result = {roster_item, '$jid', '$name',
                     '$groups', '$subscription', '$ask','$profiles'},
           attrs = [#attr{name = <<"jid">>,
                          required = true,
                          dec = {jid, decode, []},
                          enc = {jid, encode, []}},
...
-xml(iq,
	   ...
	   module = rfc6120,
           result = {iq, '$id', '$type', '$lang', '$from','$from_jid', '$to', '$_els', '$_'},
           attrs = [#attr{name = <<"id">>,
                          required = true},
                    #attr{name = <<"type">>,
                          required = true,
...
-xml(vcard_temp,
	   ...
	   module = 'xep0054',
           result = {vcard_temp, '$version', '$fn', '$n', '$nickname', '$photo',
                     ...
                     '$org','$vcard_status','$vcard_mobile_number','$vcard_designation','$vcard_coverimg','$vcard_lastName','$vcard_userType','$vcard_firstName','$vcard_image','$vcard_emailid','$vcard_nickName', '$categories', '$note', '$prodid', %% '$agent',
           ...
           refs = [#ref{name = vcard_N, min = 0, max = 1, label = '$n'},
                   ...
                   #ref{name = vcard_lastName, min = 0, max = 1, label = '$vcard_lastName'},
                   #ref{name = vcard_userType, min = 0, max = 1, label = '$vcard_userType'},
                   #ref{name = vcard_firstName, min = 0, max = 1, label = '$vcard_firstName'},
...
-xml(pubsub_item,
	   ...
	   module = 'xep0060',
	   ignore_els = true,
           result = {ps_item, '$xmlns', '$id', '$_els', '$node', '$publisher', '$admin_user'},
           attrs = [#attr{name = <<"id">>},
		    #attr{name = <<"xmlns">>},
                    #attr{name = <<"node">>},
                    #attr{name = <<"publisher">>},
...
-xml(mix_join,
	   ...
	   xmlns = <<"urn:xmpp:mix:core:0">>,
	   module = 'xep0369',
	   result = {mix_join, '$id', '$jid', '$nick', '$subscribe','$owner', '$custom_attributes'},
	   attrs = [#attr{name = <<"id">>},#attr{name = <<"owner">>,default = <<"">>},
...
-xml(mix_client_join,
	   ...
	   module = 'xep0405',
	   result = {mix_client_join, '$channel', '$join','$affiliation'},
...
-xml(mix_leave,
	   ...
	   xmlns = <<"urn:xmpp:mix:core:0">>,
	   module = 'xep0369',
	   result = {mix_leave,'$admin_user'},
        attrs = [#attr{name = <<"admin_user">>,default = <<"">>}]
        }).
...
-xml(mix_participant,
	   ...
	   module = 'xep0369',
        ignore_els = true,
	   result = {mix_participant, '$jid','$_els', '$nick'},
	   attrs = [#attr{name = <<"jid">>,
			  required = true,
			  label = '$jid',
			  dec = {jid, decode, []},
